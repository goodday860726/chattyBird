...
import { message, Card, Popover, Button, Avatar, List, Modal, Input } from 'antd';
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <Card
        ...
        title={post.RetweetId ? `${post.User.nickname}'s retweet` : null}
        extra={id && <FollowButton post={post} />}
      >
        <Modal title='report' open={modalVisible} onOk={onSubmitReport} confirmLoading={reportPostLoading} onCancel={onCloseModal}>
          <form>
